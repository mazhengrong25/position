      ...
      <div className="table">
        <div className="table_type">
          ...
          <div className="type_name">
            <div>执行模式</div>
            <div className="radio">
              <Select allowClear style={{ width: 200 }} placeholder="适用" optionFilterProp="children" notFoundContent="无法找到" onChange={this.handleExecute}>
          ...
          <div className="type_name">
            <div>配置状态</div>
            <div className="radio">
              <Select allowClear style={{ width: 200 }} placeholder="可用" optionFilterProp="children" notFoundContent="无法找到" onChange={this.handleConfig}>
                <Option value="0">所有</Option>
